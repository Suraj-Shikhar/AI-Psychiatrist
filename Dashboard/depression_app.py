...
st.set_page_config(page_title='AI Psychiatrist', page_icon = ':rain_cloud:', layout = 'centered')

# Setting the title on the page with some styling
st.markdown("<h1 style='text-align: center'>AI Psychiatrist</h1><hr style='height:2px;border-width:0;color:gray;background-color:gray'>", unsafe_allow_html=True)
...
# Add the data
df = pd.read_csv('../StreamlitData.csv', low_memory=False)
